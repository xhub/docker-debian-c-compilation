...
RUN apt-get update --yes && apt-get install --yes cmake g++-11 clang-14 clang-tools-14 cppcheck valgrind flawfinder wget ppl-dev doxygen graphviz perl libtinfo6 patch patchelf libgfortran5 openssh-client jq xz-utils \
